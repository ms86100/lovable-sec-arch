...
-- First, let's create a sample project if it doesn't exist
...
-- Create a sample milestone for the deployment phase
...
VALUES (
  'T1000000-0000-0000-0000-000000000001'::uuid,
  '33333333-3333-3333-3333-333333333333'::uuid,
...
INSERT INTO project_tasks (id, milestone_id, title, description, estimated_effort_hours, dependencies, status, priority) 
VALUES (
  'T2000000-0000-0000-0000-000000000002'::uuid,
  '33333333-3333-3333-3333-333333333333'::uuid,
  'Deploy Backend Services',
  'Deploy and configure backend API services, databases, and authentication systems',
  32, -- 4 days * 8 hours
  '["T1000000-0000-0000-0000-000000000001"]'::jsonb,
  'pending',
  'high'
) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO project_tasks (id, milestone_id, title, description, estimated_effort_hours, dependencies, status, priority) 
VALUES (
  'T3000000-0000-0000-0000-000000000003'::uuid,
  '33333333-3333-3333-3333-333333333333'::uuid,
...
INSERT INTO project_tasks (id, milestone_id, title, description, estimated_effort_hours, dependencies, status, priority) 
VALUES (
  'T4000000-0000-0000-0000-000000000004'::uuid,
  '33333333-3333-3333-3333-333333333333'::uuid,
  'Database Migration & Optimization',
  'Migrate production data and optimize database performance for security platform',
  80, -- 10 days * 8 hours
  '["T2000000-0000-0000-0000-000000000002", "T3000000-0000-0000-0000-000000000003"]'::jsonb,
  'pending',
  'high'
) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO project_tasks (id, milestone_id, title, description, estimated_effort_hours, dependencies, status, priority) 
VALUES (
  'T5000000-0000-0000-0000-000000000005'::uuid,
  '33333333-3333-3333-3333-333333333333'::uuid,
  'Frontend Deployment',
...
INSERT INTO project_tasks (id, milestone_id, title, description, estimated_effort_hours, dependencies, status, priority) 
VALUES (
  'T6000000-0000-0000-0000-000000000006'::uuid,
  '33333333-3333-3333-3333-333333333333'::uuid,
  'System Integration',
  'Integrate all components and ensure proper communication between services',
  32, -- 4 days * 8 hours
  '["T4000000-0000-0000-0000-000000000004", "T5000000-0000-0000-0000-000000000005"]'::jsonb,
  'pending',
  'high'
) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO project_tasks (id, milestone_id, title, description, estimated_effort_hours, dependencies, status, priority) 
VALUES (
  'T7000000-0000-0000-0000-000000000007'::uuid,
  '33333333-3333-3333-3333-333333333333'::uuid,
  'Performance Testing',
  'Conduct comprehensive performance and load testing of the entire system',
  40, -- 5 days * 8 hours
  '["T6000000-0000-0000-0000-000000000006"]'::jsonb,
  'pending',
  'medium'
) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO project_tasks (id, milestone_id, title, description, estimated_effort_hours, dependencies, status, priority) 
VALUES (
  'T8000000-0000-0000-0000-000000000008'::uuid,
  '33333333-3333-3333-3333-333333333333'::uuid,
  'Production Deployment',
  'Final deployment to production environment and go-live procedures',
  16, -- 2 days * 8 hours
  '["T7000000-0000-0000-0000-000000000007"]'::jsonb,
  'pending',
  'critical'
) ON CONFLICT (id) DO NOTHING;